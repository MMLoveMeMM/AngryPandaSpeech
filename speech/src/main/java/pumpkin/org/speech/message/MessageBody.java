package pumpkin.org.speech.message;
...
public class MessageBody {
    ...
    private ArrayList<MessageBody> mWidgetListItem = new ArrayList<>();
    ...
    public void addMessageBean(MessageBody bean) {
    ...
    public ArrayList<MessageBody> getMessageBeanList() {
